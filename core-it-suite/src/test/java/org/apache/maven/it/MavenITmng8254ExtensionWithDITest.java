 ...
 */
public class MavenITmng8254ExtensionWithDITest extends AbstractMavenIntegrationTestCase {
    public MavenITmng8254ExtensionWithDITest() {
        super("[4.0.0-beta-4,)");
    }
    ...
    public void testitModel() throws Exception {
        File testDir = ResourceExtractor.simpleExtractResources(getClass(), "/mng-8254-extension-with-di");
        ...
        verifier.execute();
        verifier.verifyTextInLog("[MNG-8254] DumbModelBuilder Called from extension");
    }
}
