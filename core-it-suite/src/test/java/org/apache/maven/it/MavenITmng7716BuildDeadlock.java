 ...
 *
 */
public class MavenITmng7716BuildDeadlock
    extends AbstractMavenIntegrationTestCase
{
     ...
     */
    public void testNoDeadlockAtVersionUpdate()
        throws Exception
    {
        ...
        verifier.addCliOption( "-DnewVersion=1.2.3" );
        verifier.executeGoal( "org.codehaus.mojo:versions-maven-plugin:2.15.0:set" );
        verifier.verifyErrorFreeLog();
    }
